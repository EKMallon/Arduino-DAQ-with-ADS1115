...
//#define TEXToutput     
//un-comment this define statement for text-only RAW output with the elapsed time for your reading loop
...
//Once you get your threshold set properly, you can view your output values on the serial plotter
    ...
    Serial.print(5000); Serial.print(" "); // my expected peak current~ 5mA
    //Serial.print(400); Serial.print(" ");  // You can put a line anywhere to intersect the graph output
    Serial.print(200); Serial.print(" ");  // this was the typical sleep current for the logger being tested (according to DVM)
    Serial.print(0); Serial.print(" ");    // the lowest constant sets a stable lower value for the plotter
